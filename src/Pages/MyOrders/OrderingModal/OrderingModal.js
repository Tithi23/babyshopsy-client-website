...
const OrderingModal = ({ openOrdering, handleOrderingClose, ordering, date, setOrderingSuccess }) => {
    const { name, price, quntity } = ordering;
    const { user } = useAuth();
    const initialInfo = {
    ...
    const handleOrderingSubmit = e => {
        ...
        // send to the server
        fetch('https://y-mocha-alpha.vercel.app/customers', {
            method: 'POST',
            headers: {
